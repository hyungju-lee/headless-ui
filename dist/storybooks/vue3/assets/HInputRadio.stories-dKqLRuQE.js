...
`,T={title:"headless-ui/h-input-radio",component:v,parameters:{docs:{description:{component:"라디오 버튼을 렌더링하는 컴포넌트입니다."},source:{code:x}}},argTypes:{}},n={};var c,p,m;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:"{}",...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const F=["Case1"];export{n as Case1,F as __namedExportsOrder,T as default};
