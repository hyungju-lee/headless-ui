...
<style scoped></style>
`,R={title:"headless-ui/h-pagination",component:v,parameters:{docs:{description:{component:"페이지네이션 컴포넌트입니다."},source:{code:S}}},argTypes:{}},g={};var P,x,f;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:"{}",...(f=(x=g.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};const T=["Case1"];export{g as Case1,T as __namedExportsOrder,R as default};
