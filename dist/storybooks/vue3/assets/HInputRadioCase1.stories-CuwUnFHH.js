import{d as f,r as l,l as r,A as b,P as o,F as i,D as y,f as d,g as R,j as _,O as g,u}from"./vue.esm-bundler-Cp0jskqx.js";import{c as C,w as V}from"./headless-ui-vue3.es-DDUAhZL-.js";const v=f({__name:"HInputRadioCase1",setup(I){const{checkEqual:k}=C(),t=l([{id:1,name:"radio1",value:"radio1",label:"라디오1"},{id:2,name:"radio2",value:"radio2",label:"라디오2"},{id:3,name:"radio3",value:"radio3",label:"라디오3"},{id:4,name:"radio4",value:"radio4",label:"라디오4"},{id:5,name:"radio5",value:"radio5",label:"라디오5"}]),e=l(t.value[2]);return(E,s)=>(d(),r(i,null,[b("p",null,o(e.value),1),(d(!0),r(i,null,y(t.value,(a,H)=>(d(),R(u(V),{key:a.id,name:"test",modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=h=>e.value=h),data:a,style:{display:"block"}},{default:_(()=>[g(o(u(k)(e.value,a)?"checked":"unchecked")+" "+o(a.name),1)]),_:2},1032,["modelValue","data"]))),128))],64))}});v.__docgenInfo={exportName:"default",displayName:"HInputRadioCase1",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-input-radio/HInputRadioCase1.vue"]};const x=`<script setup lang="ts">
import {ref} from "vue";
