import{d as y,r as s,b as x,l as T,t as c,j as l,u as p,A as t,O as i,y as h,z as g,N as H,f as V}from"./vue.esm-bundler-CYoyDZR-.js";import{f as N,p as k}from"./headless-ui-vue3.es-CWy2mixA.js";import"./iframe-BQ7Vut-X.js";import"../sb-preview/runtime.js";const F=y({__name:"h-check-form-data-change-case1",setup(U){const m=s(null),u=s(""),f=s("content"),{deleteComponentState:D}=N(m,window.location.href);x(()=>{D()});const d=({event:r,result:e,originalFunc:o,href:n})=>{if(e)n?(console.log(`${n}로 이동`),window.location.href=n):o(r);else{if(!confirm("작성하신 내용이 있습니다. 현재 페이지를 떠나시겠습니까?"))return;n?(console.log(`${n}로 이동`),window.location.href=n):o(r)}};return(r,e)=>{const o=H("RouterLink");return V(),T("div",null,[c(p(k),{href:"https://www.naver.com",onDataChangeVerificationResult:d},{default:l(()=>e[2]||(e[2]=[t("a",{href:"https://www.naver.com"},"네이버 이동",-1)])),_:1}),c(p(k),{onDataChangeVerificationResult:d},{default:l(()=>[c(o,{to:"/test"},{default:l(()=>e[3]||(e[3]=[i("테스트 이동")])),_:1})]),_:1}),t("form",{ref_key:"formTag",ref:m},[e[4]||(e[4]=i(" 이름: ")),h(t("input",{type:"text","onUpdate:modelValue":e[0]||(e[0]=n=>u.value=n),name:"name"},null,512),[[g,u.value]]),e[5]||(e[5]=t("br",null,null,-1)),e[6]||(e[6]=i(" 설명: ")),h(t("input",{type:"text","onUpdate:modelValue":e[1]||(e[1]=n=>f.value=n),name:"content"},null,512),[[g,f.value]])],512)])}}});F.__docgenInfo={exportName:"default",displayName:"h-check-form-data-change-case1",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-check-form-data-change/h-check-form-data-change-case1.vue"]};const R=`<script setup lang="ts">
