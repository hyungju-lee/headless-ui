import{d as b,r,g as d,j as n,u as e,f as a,l as g,t as u,O as o,F as p,v as m,D as F,P}from"./vue.esm-bundler-CYoyDZR-.js";import{H as V,x as A,O as L,N as O,R as q,P as K}from"./headless-ui-vue3.es-CWy2mixA.js";import"./iframe-BQ7Vut-X.js";import"../sb-preview/runtime.js";const y=b({__name:"h-pagination-case1",setup(D){const B=r(8),H=r(102),i=r(0),k=r("page"),I=_=>{};return(_,t)=>(a(),d(e(K),{modelValue:i.value,"onUpdate:modelValue":t[0]||(t[0]=s=>i.value=s),"count-per-page":B.value,"total-count":H.value,"query-string-key":k.value,type:"type1",onClickPaginationButton:I},{default:n(s=>[i.value!==0?(a(),g(p,{key:0},[u(e(V),null,{default:n(()=>t[1]||(t[1]=[o("처음")])),_:1}),u(e(A),null,{default:n(()=>t[2]||(t[2]=[o("이전")])),_:1})],64)):m("",!0),(a(!0),g(p,null,F(s.paginatedItems,(c,N)=>(a(),d(e(L),{key:`page_${N}`,"page-index":c},{default:n(({isActive:C})=>[o(P(c)+" "+P(C?"(active)":""),1)]),_:2},1032,["page-index"]))),128)),i.value!==s.lastPageIndex-1?(a(),g(p,{key:1},[u(e(O),null,{default:n(()=>t[3]||(t[3]=[o("다음")])),_:1}),u(e(q),null,{default:n(()=>t[4]||(t[4]=[o("마지막")])),_:1})],64)):m("",!0)]),_:1},8,["modelValue","count-per-page","total-count","query-string-key"]))}});y.__docgenInfo={exportName:"default",displayName:"h-pagination-case1",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-pagination/h-pagination-case1.vue"]};const S=`<template>
  <HPaginationArea
      #default="slotProps"
