import{d,g as p,u,f as l}from"./vue.esm-bundler-CYoyDZR-.js";import{a7 as f,a8 as y}from"./headless-ui-vue3.es-CWy2mixA.js";import"./iframe-BQ7Vut-X.js";import"../sb-preview/runtime.js";const m=d({__name:"h-loading-case1",setup(o){return(_,h)=>(l(),p(u(f),{"stroke-color":"#f00",style:{position:"relative"}}))}});m.__docgenInfo={exportName:"default",displayName:"h-loading-case1",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-loading/h-loading-case1.vue"]};const C=`<template>
...
<style scoped></style>
`,g=d({__name:"h-loading-case2",setup(o){return(_,h)=>(l(),p(u(y),{"background-color":"#f00"}))}});g.__docgenInfo={exportName:"default",displayName:"h-loading-case2",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-loading/h-loading-case2.vue"]};const L=`<template>
