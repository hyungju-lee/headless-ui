import{d as f,f as C,l as _,t as r,j as l,q as a,u as c,A as i,E as p,O as m,P as u}from"./vue.esm-bundler-CYoyDZR-.js";import{a0 as k,a1 as d}from"./headless-ui-vue3.es-CWy2mixA.js";import{_ as O}from"./plugin-vue_export-helper-DlAUqK2U.js";import"./iframe-BQ7Vut-X.js";import"../sb-preview/runtime.js";const v=f({name:"CustomIcon"});function $(H,o,I,s,n,t){return C(),_("div",null,"커스텀 아이콘")}const j=O(v,[["render",$]]);v.__docgenInfo={displayName:"CustomIcon",exportName:"default",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-html-render/CustomIcon.vue"]};const x='<span style="color: white">html tag render</span>',y=f({__name:"h-html-render-case1",setup(H){const o={html:'<button type="button">버튼</button>',on:n=>({click:()=>{console.log(n)}})},s={html:`<button type="button"><span style="color: #fff; vertical-align: middle">버튼 내용</span>${k(j,{attrs:{style:"vertical-align: middle;"}}).$el.outerHTML}</button>`,on:n=>({click:()=>{console.log(n)}})};return(n,t)=>(C(),_("div",null,[r(c(d),a({tag:"p"},{style:{backgroundColor:"blue"}}),{default:l(()=>[m(u(x))]),_:1},16),t[0]||(t[0]=i("br",null,null,-1)),r(c(d),a({tag:"div"},p(o.on("test"))),{default:l(()=>[m(u(o.html),1)]),_:1},16),t[1]||(t[1]=i("br",null,null,-1)),r(c(d),a({tag:"div"},p(s.on("test2"))),{default:l(()=>[m(u(s.html),1)]),_:1},16)]))}});y.__docgenInfo={exportName:"default",displayName:"h-html-render-case1",description:"",tags:{},sourceFiles:["/Users/nhn/study_headless_ui/ui-storybook/vue3/src/stories/h-html-render/h-html-render-case1.vue"]};const R=`<script setup lang="ts">
