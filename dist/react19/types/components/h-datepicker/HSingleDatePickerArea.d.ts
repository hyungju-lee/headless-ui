...
interface HSingleDatePickerAreaContext {
    ...
    calendarInputButtonRef: RefObject<HTMLInputElement | null>;
    calendarInputAreaRef: RefObject<HTMLDivElement | null>;
    calendarPosition: CalendarPositionType;
    calendarAreaRef: RefObject<HTMLDivElement | null>;
    calendarMonthAreaRef: RefObject<HTMLDivElement | null>;
    calendarYearAreaRef: RefObject<HTMLDivElement | null>;
    type: CALENDAR_TYPES;
