...
import { CalendarPositionType } from './types';
...
declare const SET_NOW_MONTH_BY_MONTH_CALENDAR: InjectionKey<(val: string) => void>;
declare const SET_NOW_YEAR_BY_YEAR_CALENDAR: InjectionKey<(val: string) => void>;
declare const CALENDAR_INPUT: InjectionKey<Ref<EventTarget | null>>;
...
declare const CALENDAR_DEFINE_TYPES: InjectionKey<'default' | 'type1'>;
...
declare const RANGE_TYPE: InjectionKey<ComputedRef<'startDate' | 'endDate'>>;
